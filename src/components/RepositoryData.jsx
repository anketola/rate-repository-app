    ...
    return (
        <View style={{ display: 'flex', flexDirection: 'row', paddingTop: 5, justifyContent: 'space-evenly' }}>
                <View style={{ display: 'flex', flexDirection: 'column'}}>
                    <Text style={styles.valuetext}>{formatNumber(stargazersCount)}</Text>
                    <Text style={styles.labeltext}>Stars</Text>
                </View>
                <View style={{ display: 'flex', flexDirection: 'column' }}>
                    <Text style={styles.valuetext}>{formatNumber(forksCount)}</Text>
                    <Text style={styles.labeltext}>Forks</Text>
                </View>
                <View style={{ display: 'flex', flexDirection: 'column'}}>
                    <Text style={styles.valuetext}>{formatNumber(reviewCount)}</Text>
                    <Text style={styles.labeltext}>Reviews</Text>
                </View>
                <View style={{ display: 'flex', flexDirection: 'column'}}>
                    <Text style={styles.valuetext}>{formatNumber(ratingAverage)}</Text>
